package com.example.collegeadmissionsapplication.UI.Animation;
...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, final View startView, View endView,
        ...
        float startViewHightCenter = startView.getHeight() / 2f;
        ...
        float fromY = startPos[1] - startViewHightCenter;
        float toY = endPos[1] - endViewHeightCenter + startViewHightCenter;
        ...
        ScaleAnimation startScaleAnimation = new ScaleAnimation(1.0f,1.5f,1.0f,1.5f, startViewWidthCenter, startViewHightCenter);
